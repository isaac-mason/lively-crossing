...
# public/ so Vite serves it. Defaults to "assets/anime-city.spz" and RAD output
# (Spark's native LOD format), producing "public/anime-city-lod.rad".
#
# Examples:
#   scripts/build-lod.sh
#   scripts/build-lod.sh "assets/anime-city.spz"
